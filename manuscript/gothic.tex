...
Welchen Herausforderungen man sich mit diesem Repertoire an spielerischen Möglichkeiten hätte stellen können sollen, verraten zwei Seiten, die mit \enquote{\uline{Aufträ\-ge}} überschrieben sind.\autocite[Vgl.][S.~16--17]{orpheus_b_scribbles}
Neben der Überschrift ist die Devise \enquote{\uline{Jagen \& sammeln} (\uline{Wenig} Detektivaufträge)} vermerkt.
Es folgt eine Liste mit 22 Ideen für Aufgaben:
...
\begin{quote}
   \begin{itemize}
      ...
      \item[11)] NSC X hat Item Y $\rightarrow$ Beschaffen\footnote{}
   \end{itemize}
\end{quote}
