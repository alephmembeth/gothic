...
Außerdem sind zwei weitere -- später wieder durchgestrichene -- Ideen für einen \enquote{\st{General Button 2}} sowie einen \enquote{\st{General Button 3}} notiert.
Mit ersterem hätte man zwischen \enquote{\st{Alle Warten/Alle Folgen/Alle Kampf}} und mit zweiterem zwischen \enquote{\st{Kampf/Alle Still}} umschalten können sollen,\autocite[S.~5]{orpheus_interface} wonach sich \enquote{General} also immer auf die ganze Gruppe zu beziehen scheint.
