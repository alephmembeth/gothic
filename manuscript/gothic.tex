...
Aus dieser frühen Phase -- wir sprechen ungefähr von den Jahren 1995 und 1996 -- ist eine Handvoll Dokumente erhalten, in denen Mike Hoge erste Ideen festgehalten hat,\footnote{Diese Dokumente wurden von ihm den Betreibern des \textit{Gothic Archives} zur Verfügung gestellt, die sie digitalisiert und zugänglich gemacht haben; vgl. \autocite{archive_orpheus}.} von denen es am Ende viele, wie wir sehen werden, auch in das fertige Spiel geschafft haben.
...
\begin{itemize}
   ...
   \item \enquote{Zusammenfassung zum Orpheus-Konzept. Graphiken}\footnote{\autocite{orpheus_zusammenfassung}. Hierbei handelt es sich vermutlich um einen Teil einer umfangreicheren Zusammenfassung, von der nur der Abschnitt zur Grafik erhalten geblieben ist.}
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Spielmechanik und Steuerung}\label{sec:orpheus_technik}
