...
In diesem Bewusstsein sind inzwischen sowohl in Deutschland wie auch international zahlreiche Sammlungen -- einige in privater Hand, andere in öffentlicher Trägerschaft -- entstanden, deren Bestand an Videospielen bis in die Zehntausende reicht. Sebastian Möring resümiert:
...
Nur vergleichsweise selten widmet man sich den Vorstufen dieses Materials, den groben Ideenskizzen, den frühen Entwürfen und Designdokumenten, den Alpha- oder Betaversionen der Spiele, den internen Entwicklungswerkzeugen und so weiter.
...
Oft ist dabei nur noch mit Mühe nachzuvollziehen, wie dieser Weg aussah.
Durch die Weiten des Netzes geistern unter anderem -- um nur ein paar wenige Beispiele zu nennen -- Designdokumente von \textit{Diablo} (1996), \textit{Doom} (1993), dem nie erschienenen \textit{Fallout: Brotherhood of Steel 2}, \textit{Grim Fandango} (1998), \textit{Planescape: Torment} (1999), \textit{Silent Hill} (1999) oder \textit{Tron} (1982).\footnote{Diese Beispiele hat Mikael Segedi gesammelt und zugänglich gemacht (vgl. \autocite{segedi_famous_2015}).}


Manchmal sammeln Liebhaber*innen solche Dokumente online, wie beispielsweise im Fall von \textit{Tomb Raider} oder \textit{Gothic}.\autocite[Vgl.][]{core_design_tomb_raider} In einigen Fällen wird eine solche Veröffentlichung aber auch von Entwicklern*innen oder Publishern selbst forciert.
...
Dass diese Fälle eher Ausnahmen zu bleiben und der Fokus von Sammlungen in erster Linie auf offiziell veröffentlichtem Material zu liegen scheint, ist kaum verwunderlich.
...
Hier ist unter Umständen also ein komplexes Netz geistigen Eigentums zu beachten.
Zudem entstehen Videospiele überwiegend im Kontext marktwirtschaftlich agierender Unternehmen, die sich wahrscheinlich oft nicht in die eigenen Karten der Spieleproduktion blicken lassen möchten.
...
Hier ist ein Brückenschlag zur Editionswissenschaft nötig.
...
Dieser Band soll natürlich keine historisch-kritische Bearbeitung bieten, aber ich möchte unterstreichen, dass Videospiele, wenn man sie als Kulturgüter begreift, es verdient haben, nicht nur in ihrem Ergebnis, sondern auch in ihrer Entstehung ernst genommen zu werden.
...
Vor diesem Hintergrund mag es sich also durchaus lohnen, einen genaueren Blick auf 
