...
Manchmal sammeln Liebhaber solche Dokumente online, wie beispielsweise im Fall von \textit{Tomb Raider} oder \textit{Gothic}.\autocite[Vgl.][]{core_design_tomb_raider} In einigen Fällen wird eine solche Veröffentlichung aber auch von Entwicklern oder Publishern selbst forciert.
...
Dass diese Fälle eher Ausnahmen zu bleiben und der Fokus von Sammlungen in erster Linie auf offiziell veröffentlichtem Material zu liegen scheint, ist natürlich kaum verwunderlich.
...
\begin{quote}
   ...
   Dazu ist es notwenig, nicht nur sämtliche Materialien eines zu edierenden Werkes oder Textes zu sichten, sondern die Arbeitsstadien aus diesem Material zu ermitteln, diese zur Entstehung in Beziehung zu setzen und den zu rekonstruierenden Entstehungsprozeß in seiner ganzen Komplexität bis zu einer eventuellen Publikation zu verfolgen.
\end{quote}

Dieser Band soll keine historisch-kritische Bearbeitung bieten, aber ich möchte unterstreichen, dass Videospiele, wenn man sie als Kulturgüter begreift, es verdient haben, nicht nur in ihrem Ergebnis, sondern auch in ihrer Entstehung ernst genommen zu werden.
