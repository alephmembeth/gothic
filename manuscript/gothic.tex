...
\enquote{Spielmechanik} verstehe ich dabei relativ weit gefasst als die Menge an Möglichkeiten, die Spieler:innen zur Verfügung steht, um mit Spielelementen interagieren zu können.\autocite[255]{jaervinen_games_2008}
...
Wir werfen zuerst einen Blick darauf, welche Möglichkeiten Spieler:innen geboten werden sollten (\autoref{sec:orpheus_mechanik_möglichkeiten}) und schauen uns anschließend an, wie sich das Ganze hätte steuern lassen sollen (\autoref{sec:orpheus_mechanik_steuerung}).
...
Unter diesen drei wegweisenden Stichpunkten folgt dann eine von (a) bis (p) reichende Liste mit Möglichkeiten, die Spieler:innen haben sollten:
