...
\noindent Zum \enquote{\uline{Alkohol}} wiederum ist an einer Stelle vermerkt:
\enquote{Bier \& Wein}, mit der Entsprechung \enquote{3 Bier $=$ 1 Faß $=$ 1 Fl[asche] Wein $\rightarrow$ viel Wert}.\autocite[S.~6]{orpheus_b_scribbles} Die (anderen) Drogen wiederum sollten scheinbar nicht nur aus der Außenwelt kommen.
