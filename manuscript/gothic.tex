...
Wir finden beispielsweise sektiererischen Fanatismus (wenn ein Abtrünniger getötet werden soll), die Sicherung einer guten Ernte (wenn Monster unter den Feldern getötet werden sollen), machtpolitische Ränkespiele (wenn jemand getötet werden soll, der sich gegen eine herrschende Fraktion aufgelehnt hat) oder das Streben nach besseren Lebensumständen (wenn jemand von einer Fraktion zu einer anderen überlaufen möchte).

Auch eine Einbindung in die Spielwelt findet sich schon stellenweise:
