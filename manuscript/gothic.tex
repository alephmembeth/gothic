...
%%%%%%%%%%%
\chapter{Quellen}
Wird ein Archivdokument das erste Mal eingehender behandelt, stelle ich es mit einer knappen Handschriften- beziehungsweise Dokumentenbeschreibung vor.
...
Fehler in Orthographie und Interpunktion werden nicht korrigiert; stattdessen wird in eckigen Klammern mit dem lateinischen \textit{sic} darauf hingewiesen, dass die jeweilige Schreibweise aus der Vorlage stammt.
Andere Kommentare, Ergänzungen, Anpassungen und Auslassungen werden ebenfalls in eckigen Klammern eingefügt.

Finden sich in der Vorlage Durchstreichungen, Unterstreichungen, Sperrungen, Kursivierungen, Fettdruck oder ähnliches, wird dies entsprechend kenntlich gemacht.
Textfarben sowie Zeilen- oder Seitenwechsel werden dagegen nicht ausgewiesen.
