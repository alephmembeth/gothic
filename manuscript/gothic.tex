...
Bei sechs dieser sieben Seiten handelt es sich um Blanko-Bögen (aller Wahrscheinlichkeit nach Druckerpapier im Format DIN A4), eines folgt dementgegen einer karierten Lineatur und weist am linken Rand eine standardisierte Vierfachlochung sowie einen Marginalsteg auf (ganz offensichtlich einem handelsüblichen Notizblock entnommen).
...
Die \enquote{\uline{Aufträge}} sind in dem Konvolut \enquote{\textsc{Orpheus. B -- Scribbles}} enthalten.
