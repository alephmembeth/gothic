...
% ORPHEUS – TECHNIK %
%%%%%%%%%%%%%%%%%%%%%
\section{Technik und Darstellung}\label{sec:orpheus_technik}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ORPHEUS – TECHNIK – INVENTAR %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Inventar}\label{sec:orpheus_technik_inventar}
Sieben mit (blauem) Kugelschreiber und (ursprünglich wahrscheinlich schwarzem, mittlerweile eher ins Braune tendierendem) Fineliner handbeschriebene Seiten sind mit \enquote{\uline{Orpheus -- Interface}} überschrieben.
