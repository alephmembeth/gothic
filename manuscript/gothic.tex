...
\title{Gothic}
\subtitle{Eine Spurensuche im Entwickler‑Archiv}
...
Auf der Karte der Kolonie endet das Gebiet östlich in einem großen \enquote{Wald} und reicht noch nicht, wie im fertigen Spiel, darüber hinaus bis zu einer Küstenlinie.
Das spätere Sektenlager liegt noch nord- statt südöstlich und die Orks -- hier als \enquote{\uline{Halborks}} -- finden wir im Gebiet des östlichen Waldes statt in den südwestlichen Bergen.
...
Von späterer Hand ist auf der Karte außerdem vermerkt: Das \enquote{\textsc{Erz} interessiert [die] Orks \uline{nicht}}.
