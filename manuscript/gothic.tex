...
Im Bereich der Magie finden wir die rollenspielklassische Fähigkeit \enquote{Magie erkennen},\autocite[S.~2]{orpheus_gildensystem} die wir beispielsweise aus der -- zur Zeit von \textit{Orpheus} gängigen -- zweiten Edition von \textit{Advanced Dungeons \& Dragons} kennen.\autocite[S.~133]{cook_adnd_1989} % Mike fragen, was sie damals so gespielt haben

% \enquote{Magic Missile}
% \enquote{Heilmagiersprüche}
% \enquote{Kampfmagier Sprüche}
% \enquote{\textsc{Psi}-Spells bis Telekinetic Storm}, \enquote{$\rightarrow$ Spruchtabelle!}
% \enquote{\textsc{Psi}-Sprüche ab Levitation}
