...
Drei kleine Skizzen lassen vermuten, dass sich die Kamera -- zumindest wenn man die Spielfigur aus der Verfolgerperspektive spielt (siehe \autoref{sec:orpheus_darstellung_kamera}) -- beim Öffnen des Inventars in einem Halbkreis um die Spielfigur herum hätte bewegen sollen, so dass man sie am Ende von vorne sieht.
Dabei hätte sie außerdem nicht mehr zentriert dargestellt werden sollen, sondern wäre weiter an den rechten Bildschirmrand verschoben worden.
Im nun offenen Inventarbildschirm hätte damit ein \enquote{ingame \uline{pic}} unserer Figur...
