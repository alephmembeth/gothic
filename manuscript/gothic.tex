...
Zentral ist bei den dort festgehaltenen Überlegungen die Distanz zum Gegner und wie sich diese durch die eigene Bewegung (etwa durch einen Angriff mit Ausfallschritt nach vorne oder durch eine Parade mit Schritt nach hinten) und die Bewegung des Gegners (etwa durch ein Zurückweichen beim Getroffenwerden) verändert.
In einer Tabelle ist minutiös festgehalten, welche Art von Angriff welche Auswirkungen auf einen Gegner in welcher Distanz haben soll.
Dabei wird unterschieden zwischen vier für den Nahkampf relevanten Distanzen, vier möglichen Tastatureingaben (Strg und W, A, S, oder D) sowie einem Angriff mit der Faust oder mit einer von drei Waffen (Dolch, Schwert und Zweihänder), mit denen man entweder geübt oder ungeübt sein kann, was in einer Tabelle mit immerhin 112 Zellen resultiert.
Die in den Notizen erwähnte Möglichkeit, einen Schild zu tragen, hat es nicht ins fertige Spiel geschafft, aber ein anderer Stichpunkt beschreibt etwas, das den meisten Spielern nicht fremd sein wird: \enquote{Ein liegender Gegner wird mit Ctrl $\uparrow$ erstochen}.
