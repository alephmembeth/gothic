...
Durch die Weiten des Netzes geistern unter anderem -- um nur ein paar wenige Beispiele zu nennen -- Designdokumente von \textit{Diablo}, \textit{Doom}, \textit{Fallout: Brotherhood of Steel 2}, \textit{Grand Theft Auto}, \textit{Grim Fandango}, \textit{Planescape: Torment}, \textit{Silent Hill} oder \textit{Tron}.\footnote{Diese Beispiele hat Mikael Segedi gesammelt und zugänglich gemacht (vgl. \autocite{segedi_famous_2015}).}
In seltenen Fällen wird eine solche Veröffentlichung aber auch von Entwicklern oder Publishern selbst forciert.
Al Lowe beispielsweise hat auf seiner Homepage unter anderem Dokumente zu einigen Teilen von 
\textit{Leisure Suit Larry} zugänglich gemacht.\autocite{lowe_designs_2025}
Auch Aric Wilmunder hatte auf seiner -- inzwischen nicht mehr erreichbaren -- Homepage eine ganze Reihe von Designdokumenten öffentlich gemacht, die sich über lange Jahre in seinem Besitz befanden.
