...
\begin{itemize}
   ...
   \item \enquote{Zusammenfassung zum Orpheus-Konzept. Graphiken}\footnote{\autocite{orpheus_zusammenfassung}. Hierbei handelt es sich vermutlich um einen Teil einer ursprünglich umfangreicheren Zusammenfassung, von der nur der Abschnitt zur Grafik erhalten geblieben ist.}
\end{itemize}
...
Aus der \enquote{Zusammenfassung zum Orpheus-Konzept} ist nur ein Abschnitt zu \enquote{\ul{Graphiken}} erhalten, der seinerseits unterteilt ist in \enquote{\ul{Spielansicht}}, \enquote{\ul{Spielfigurenanimation}}, \enquote{\ul{Getrennt animierte \textsc{gams}}}, \enquote{\ul{Diverse Mashes}} sowie \enquote{\ul{Texturen}}.
