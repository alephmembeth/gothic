...
Im Bereich der Magie finden wir die rollenspielklassische Fähigkeit \enquote{Magie erkennen}\autocite[S.~2, 7]{orpheus_gildensystem} sowie die beiden Zaubersprüche \enquote{Featherfall}\autocite[S.~9]{orpheus_gildensystem} und \enquote{Magic Missile} (letzterer nicht unter dem \enquote{\textsc{\uline{Lernprogramm}}}, sondern unter den \enquote{\textsc{\uline{Eintrittsvoraussetzungen}}} für die \enquote{\uline{Kampfmagier}}).\autocite[S.~2]{orpheus_gildensystem}
Sowohl die Fähigkeit als auch die beiden Sprüche kennen wir beispielsweise aus der -- zur Zeit von \textit{Orpheus} gängigen -- zweiten Edition von \textit{Advanced Dungeons \& Dragons}.\footnote{Vgl. \autocite[S.~133, 134, 136]{cook_adnd_1989}, sowie \autocite[S.~171, 173]{cook_adnd_1996}.} % Mike fragen, was sie damals so gespielt haben
...
Während \enquote{Telekinetic Storm} erst mit dem 2015 für \textit{Pathfinder} erschienenen Quellenbuch \textit{Occult Adventures} als populärer Zauberspruch in Erscheinung zu treten scheint,\autocite[Vgl.][S.~188]{bulmahn_pathfinder_2015} kennen wir \enquote{Levitation} als \enquote{Levitate} ebenfalls schon aus \textit{Advanced Dungeons \& Dragons}.\footnote{Vgl. \autocite[S.~143]{cook_adnd_1989}, sowie \autocite[S.~186]{cook_adnd_1996}, dort als \enquote{Schweben}.} % Mike fragen, woher Telekinetic Storm stammt

% \enquote{$\rightarrow$ Spruchtabelle!}
% siehe \autoref{sec:orpheus_mechanik_magie})

% \enquote{Backstab}
% \enquote{Major Backstab}
% \enquote{Stealth}
% \enquote{Ausweichen}
% \enquote{Hide in Shadows}
% \enquote{Verkleiden}
% \enquote{Lügen}
% \enquote{Schlösser öffnen}

% \enquote{Akrobatik}
% \enquote{Akrobatischer Sprung}
% \enquote{klettern}
% \enquote{manche Fallen [stellen]
% \enquote{Fallen entschärfen}
% \enquote{Fallen erkennen}
% \enquote{pickpocket}


% \enquote{Critical Hit}
...
% \enquote{Waffen heben \uline{Tarnung auf!}}\autocite[S.~18]{orpheus_b_scribbles}
...
% \enquote{\textsc{Cure}-Spruch} \autocite[S.~7]{orpheus_gildensystem}
