...
\enquote{In den langen Jahren seiner Herrschaft war es ihm gelungen, alle Widersacher des Reiches zu bezwingen}, fährt die Stimme aus dem Off fort.
...
Von irgendwo ertönt das Kommando: \enquote{Feuer!}
...
Arbeiter schwingen ihre Spitzhacken, hinter ihnen stehen Wächter, ihre Arme in die Seiten gestemmt, auf dem Boden liegen Haufen blauen Erzes.
...
Die Sicheln geben den Kristall frei, der sich in einen Ball aus Energie zu verwandeln scheint und in Richtung der Burg fliegt, deren nächtliche Silhouette wir schon in der vorherigen Szene gesehen haben.
...
Eine der beiden weist mit der Hand nach oben, als sich von hinten ein Arbeiter nähert und ihr eine Spitzhacke in den Rücken rammt.
\enquote{Mehr als eine Sekunde der Unachtsamkeit brauchten die Gefangenen nicht.}
Der Arbeiter zieht seine Spitzhacke aus dem Rücken der bäuchlings auf dem Boden liegenden Wache, ein anderer schneidet einer weiteren derweil von hinten mit dem Messer die Kehle durch.
\enquote{Khorinis war nun in den Händen der Gefangenen.}

\enquote{Der König hatte keine Wahl.«}
Rhobar II. erhebt sich von seinem Thron und übergibt einem Boten eine Schriftrolle, der sie durch die Barrier wirft, wo sie vor den Füßen eines Häftlings landet.
...
Und so ist es auch der Magier, der fortfährt:
...
Einer von ihnen zieht ihn mit den Worten \enquote{Willkommen im Lager} zu sich herauf -- und verpasst ihm einen Faustschlag mitten in's Gesicht.
Für einen Augenblick ist alles Schwarz.
Von irgendwoher hört man schließlich:
\enquote{Das reicht, lasst ihn in Ruhe.
Macht, dass ihr wegkommt.}
Als er die Augen wieder aufschlägt, steht eine andere, im gleichen dunklen Rot gekleidete Person neben dem Häftling.
...
Spätestens jetzt wird klar: Dieser Häftling, das ist die Spielfigur.
Das sind wir.
Vor uns steht die rotgekleidete Person, die einen Augenblick zuvor die drei vertrieben hat, die uns schikaniert haben.
Sie trägt breit auslaufende Schulterplatten, eine bauschige, aus roten und schwarzen Quadraten zusammengeflickte Hose, die in seinen Stiefeln zu stecken scheint.
...
Aber noch sind wir kein Held, sondern nur ein weiterer Gefangener in der Kolonie.
...
Da trifft es sicht gut, dass es nicht nur reine Nächstenliebe war, aus der heraus Diego uns geholfen hat:
...
Wir erfahren außerdem, dass Bullit, dem wir ein blaues Auge zu verdanken haben, ebenfalls im Alten Lager zu finden ist.
...
\enquote{Es treiben sich jede Menge wilder Bestien zwischen den Lagern herum}, erfahren wir, \enquote{Ohne Waffe zu gehen ist Wahnsinn.}
Auf dem Weg zum Alten Lager sollen wir uns ein bisschen umschauen, rät Diego.
...
\enquote{Danke für die Hilfe}, verabschieden wir uns von Diego.
...
Außerdem werden wir uns wohl für eines der drei Lager entscheiden müssen.
Und schlussendlich:
...
Bei \enquote{\uline{\textsc{Orpheus} -- Interface}} handelt es sich um sieben mit (blauem) Kugelschreiber und (ursprünglich wahrscheinlich schwarzem, mittlerweile eher ins Braune tendierendem) Fineliner handbeschriebene Seiten.\footnote{Hinter dieser Überschrift ist mit rotem Fineliner -- wahrscheinlich von späterer Hand -- der Hinweis \enquote{V1} ergänzt worden. Anders als bei \enquote{\textsc{Orpheus} -- Spielwelt/Gildensystem} ist hier aber keine zweite Version erhalten.}
Auf der ersten Seite\autocite[Vgl.][S.~1]{orpheus_interface} begegnen uns an oberster Stelle drei nummerierte Stichpunkte mit grundlegende Designentscheidungen:
...
Den Namenlosen Helden sehen wir immer aus der Ferfolgerperspektive, die Steuerung unterstützt zwar Mauseingabe, bleibt in der Hauptsache aber auf die Tastatur fokussiert, und alle Gegenstände, die wir in der Spielwelt finden können, sind in der Engine als virtuelle Objekte angelegt.
