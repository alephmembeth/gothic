...
Hierin zeichnet sich, so scheint es mir zumindest, ein Trend darin ab, wie sich Videospielen und dem sie umgebenden Kosmos als bewahrenswerte Gegenstand angenommen wird.
\enquote{Am Anfang}, schreibt Möring, \enquote{steht bei den meisten Sammlungen die Frage nach den Objekten, welche gesammelt werden sollen.
Das Augenmerk liegt oft zunächst vor allem auf der Computerspielsoftware, die auf verschiedenen Datenträgern vorgehalten wird.}\autocite[S.~121]{moering_kulturarchive_2020}
