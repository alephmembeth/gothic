...
Sie zieht sich durch einen Großteil der Notizen zu \textit{Orpheus} und kulminiert mit \enquote{\textsc{Orpheus} -- Spielwelt/Gildensystem} sowie \enquote{\textsc{Orpheus} -- Spielwelt/Gildensystem V2} in zwei Versionen eines handschriftlich verfassten und dann kopierten Formulars, in dem Mike Hoge verschiedene Eckpunkte zu den verschiedenen Gruppen festgehalten hat (siehe \autoref{fig:orpheus_gilden_1} and \autoref{fig:orpheus_gilden_2}).
Die erste Version enthält unter anderem Felder für den Ort, an dem eine Gruppe zu finden ist, für ihre soziale Funktion, ihren Ausbruchsplan (wenn sie denn einen hat), zu welchen anderen Gruppen sie gute, neutrale oder schlechte Beziehungen führt, welche Voraussetzungen man erfüllen muss, um sich der Gruppe anschließen zu können und welche Fähigkeiten man dort als Mitglied erlernen kann.
In der zweiten Version wird eine Angabe für die Größe der Gruppe ergänzt und es werden die Beziehungen zu jeder anderen existierenden Gruppe einzeln spezifiziert.
Viele, wenn auch nicht alle, der hier entworfenen Gruppen haben es am Ende ins Spiel geschafft, oft unter anderem Namen.
