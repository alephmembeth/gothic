...
Drei der oben genannten Dokumente befassen sich mit Überlegungen zur Darstellung des Spiels:
...
Zunächst ein paar Worte zu den drei Dokumenten.
...
In der \enquote{Zusammenfassung} ist unter \enquote{\uline{Spielansicht}} festgehalten, dass zu dieser Zeit insgesamt drei verschiedene Kameraperspektiven vorgesehen waren.
...
Jede (menschliche) Figur, erfahren wir in der \enquote{Zusammenfassung} unter \enquote{\uline{Spielfigurenanimation}}, sollte aus 15 sogenannten \enquote{\textbf{Limbs}} bestehen, \enquote{einzelnen starren Körperbestandteilen}, die  jeweils \enquote{als ein festes Drahtgittermodell [abgespeichert]} und über \enquote{\textit{Anschlußpunkte}} miteinander verbunden werden.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ORPHEUS – GRAFIK – BEWEGUNGSUMFANG %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Bewegungsumfang}\label{sec:orpheus_grafik_bewegungsumfang}
...
Eine ähnliche Auflistung geplanter Animationen finden wir in der \enquote{Zusammenfassung} am Ende eines Abschnitts zur \enquote{\uline{Spielfigurenanimation}}.
...
In der \enquote{Zusammenfassung} sind einige Ideen zusammengefasst, die...
