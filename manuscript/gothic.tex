...
Von den oben genannten Dokumenten befassen sich weite Teile von \enquote{Orpheus -- Interface} (siehe auch \autoref{sec:orpheus_darstellung}) sowie die Notizen zur Kampfsteuerung im weitesten Sinne mit solchen spielmechanischen sowie steuerungsbezogenen Fragen.
...
Auf der ersten Seite von \enquote{\uline{\textsc{Orpheus} -- Interface}} (siehe hierzu auch \autoref{sec:orpheus_darstellung_inventar}) begegnen uns an oberster Stelle drei nummerierte Stichpunkte mit grundlegende Designentscheidungen:
