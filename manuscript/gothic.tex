...
Aus dieser frühen Phase -- wir sprechen ungefähr von den Jahren 1995 und 1996 -- ist eine Handvoll Dokumente erhalten, in denen Mike Hoge erste Ideen festgehalten hat.\footnote{Diese Dokumente wurden den Betreibern des \textit{Gothic Archives} von ihm zur Verfügung gestellt, die sie digitalisiert und zugänglich gemacht haben; vgl. \autocite{archive_orpheus}.}
...
\enquote{Orpheus -- Bewegungen} sowie das Überbleibsel zu \enquote{Graphiken} aus der andernfalls verschollenen \enquote{Zusammenfassung zum Orpheus-Konzept}.
