...
Auch in dem Konvolut \enquote{Orpheus. B -- Scribbles} finden sich relevante Stichpunkte.
Unter \enquote{Spielmechanik} verstehe ich dabei mit Aki Järvinen die Möglichkeiten, mit denen Spieler:innen mit Spielelementen interagieren können.
Diese Möglichkeiten lassen sich in der Regel -- wie wir unten sehen werden -- durch Verben beschreiben.

Wir werfen zuerst einen Blick auf einige generelle Überlegungen dazu, was es im Spiel geben sollte ().
Anschließend werden wir uns der Steuerung widmen, bevor wir...


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ORPHEUS – SPIELMECHANIK UND STEUERUNG – ENTSCHEIDUNGEN %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Auf der ersten Seite\autocite[Vgl.][S.~1]{orpheus_interface} begegnen uns an oberster Stelle drei nummerierte Stichpunkte:
