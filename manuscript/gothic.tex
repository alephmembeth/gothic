...
Während \enquote{Telekinetic Storm} erst mit dem 2015 für \textit{Pathfinder} erschienenen Quellenbuch \textit{Occult Adventures} als populärer Zauberspruch in Erscheinung zu treten scheint,\autocite[Vgl.][S.~188]{bulmahn_pathfinder_2015} kennen wir \enquote{Levitation} ebenfalls aus \textit{Advanced Dungeons \& Dragons} (hier als \enquote{Levitate}).\footnote{Vgl. \autocite[S.~143]{cook_adnd_1989}, sowie \autocite[S.~186]{cook_adnd_1996}, dort als \enquote{Schweben}.} % Mike fragen, woher Telekinetic Storm stammt
...
Wir finden Klassiker wie \enquote{Stealth},\autocite[S.~5]{orpheus_gildensystem} \enquote{Hide in Shadows}\autocite[S.~5]{orpheus_gildensystem} oder \enquote{Pickpocket}.\autocite[S.~9]{orpheus_gildensystem}

% \enquote{Backstab}\autocite[S.~5]{orpheus_gildensystem}
...
% \enquote{Fallen erkennen}\autocite[S.~9]{orpheus_gildensystem}
% \enquote{Fallen entschärfen}\autocite[S.~9]{orpheus_gildensystem}
% \enquote{\sout{alle Fallen} manche Fallen [stellen]\footnote{\autocite[S.~13]{orpheus_gildensystem}. Siehe auch \autocite[S.~15]{orpheus_gildensystem}.}

% \enquote{Schlösser öffnen}\autocite[S.~9]{orpheus_gildensystem}
