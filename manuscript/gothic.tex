...
Zusätzlich finden sich einige lose Notizen in \enquote{\textsc{Orpheus. B -- Scribbles}}, die eine Eskalationsspirale beschreiben.\autocite[Vgl.][S.~10]{orpheus_b_scribbles}
Zunächst, heißt es hier, wird eine der Minen ungangbar (\enquote{Mine läuft voll}) und das Alte Lager beschließt, die Freie Mine zu überfallen (\enquote{AL überfällt FM}).
Als Resultat versiegt der Nachschub an Erz für die Heilmagier (\enquote{HM kein Erz}) und an Drogen für das Sektenlager (\enquote{\textsc{Psi} keine Drogen}), das diese -- folgt man einem Diagramm an anderer Stelle im Konvolut -- von den Freien Buddlern erhält, die sie wiederum von der Außenwelt im Tausch für Erz beziehen.\autocite[Vgl.][S.~13]{orpheus_b_scribbles}
Die Feindschaft zwischen Altem und Neuem Lager führt außerdem dazu, dass man sich als Spieler beim jeweils anderen \enquote{nur reinschleichen} kann, sollte man der gegnerischen Fraktion angehören.
Und als sei das noch nicht genug, finden nun auch noch die Orks den Weg aus ihren Höhlen an das Tageslicht (\enquote{Orks kommen raus}) und \enquote{besetzen [den] Marktplatz}.
An der Oberwelt stellen sie ab nun eine zusätzliche Bedrohung dar (\enquote{OW unsicher}).
