...
Einen Einblick in die geplanten Fähigkeiten gewinnen wir unter anderem durch die Eintragungen in der ersten Version von \enquote{\textsc{Orpheus} -- Spielwelt/Gildensystem}, wo für viele \enquote{\textsc{\uline{Gilde[n]}}} ein \enquote{\textsc{\uline{Lernprogramm}}} vermerkt ist.
...
Wir finden ferner einige körperliche Fähigkeiten wie \enquote{Akrobatischer Sprung},\footnote{Vgl. \autocite[S.~9]{orpheus_gildensystem}, vermutlich identisch mit \enquote{Akrobatik} (\autocite[S.~14]{orpheus_b_scribbles}).} \enquote{klettern}\autocite[S.~9]{orpheus_gildensystem} oder \enquote{Schwimmen}, \autocite[S.~14]{orpheus_b_scribbles} die uns auch in \textit{Advanced Dungeons \& Dragons} begegnen.\autocite[S.~61, 64]{cook_adnd_1989}
...
In den Notizen zur Kampfsteuerung (siehe auch \autoref{sec:orpheus_mechanik_steuerung}) erfahren wir immerhin, dass es sowohl für \enquote{Dolch}, \enquote{Schwert} als auch \enquote{Zweihänder} jeweils ein \enquote{\textsc{Talent}} geben sollte.\footnote{\autocite{orpheus_kampfsteuerung}, S.~4\,f.; vgl. auch \enquote{\uline{\textsc{Talent} (Schwertk.)}} (\autocite[S.~1]{orpheus_kampfsteuerung}).}
Außerdem ist hier die Rede von einem \enquote{\textsc{\uline{Berserkerschlag}}},\footnote{\autocite[S.~1]{orpheus_kampfsteuerung}; vgl. auch S.~2\,f.} wobei unklar bleibt, was genau sich dahinter verbirgt. % Mike fragen
