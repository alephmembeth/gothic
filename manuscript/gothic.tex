...
Den Anfang machen Überlegungen zur Animation (\autoref{sec:orpheus_grafik}), gefolgt von Ideen zur Spielmechanik und Steuerung (\autoref{sec:orpheus_mechanik}) sowie zur Geschichte des Spiels (\autoref{sec:orpheus_geschichte})...
...
Zwei der oben genannten Dokumente befassen sich mit Überlegungen zu Grafik und Animation des Spiels:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ORPHEUS – TECHNIK – ANIMATIONSUMFANG %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ORPHEUS – TECHNIK – ANIMATIONSTECHNIK %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
