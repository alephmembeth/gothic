...
Sowohl die Fähigkeit als auch die beiden Sprüche kennen wir beispielsweise aus der -- zur Zeit von \textit{Orpheus} gängigen -- zweiten Edition von \textit{Advanced Dungeons \& Dragons}.\autocite[S.~133]{cook_adnd_1989} % Mike fragen, was sie damals so gespielt haben
...
Während \enquote{Telekinetic Storm} erst mit dem 2015 für \textit{Pathfinder} erschienenen Quellenbuch \textit{Occult Adventures} als populärer Zauberspruch in Erscheinung zu treten scheint,\autocite[S.~188]{bulmahn_pathfinder_2015} kennen wir \enquote{Levitation} als \enquote{Levitate} ebenfalls schon aus \textit{Advanced Dungeons \& Dragons}.\autocite[S.~143]{cook_adnd_1989} % Mike fragen, woher Telekinetic Storm stammt
