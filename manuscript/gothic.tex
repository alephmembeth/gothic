...
Fehler in Orthographie oder Interpunktion werden nicht korrigiert; stattdessen wird in eckigen Klammern mit dem lateinischen \textit{sic} darauf hingewiesen, dass die jeweilige Stelle in dieser Form aus der Vorlage stammt.
...
Finden sich in der Vorlage Durchstreichungen, Unterstreichungen, Sperrungen, Kursivierungen, Fettdruck oder ähnliches, wird dies übernommen.
Zeilen- oder Seitenwechsel werden dagegen nicht ausgewiesen.
Worttrennungen am Zeilenende werden entsprechend aufgelöst und Trennzeichen werden getilgt.
