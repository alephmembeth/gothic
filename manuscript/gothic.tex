...
Der Spieler sollte stattdessen erst im Laufe des Spiels \enquote{durch [die] Gildenpläne} mit den verschiedenen Ausbruchsvorhaben in Berührung kommen.
...
Auch einige Notizen zum Setzen der Stimmung finden sich hier.
...
Der Spieler sieht die \enquote{Schläferfratze im Intro} als \enquote{Wasser\uline{schemen} (durch Aufprall?)} und später als \enquote {schemen[hafte] Fratze} im \enquote{Rauch}, nachdem er durch den \enquote{\textsc{Psi}[-]Missionar} irgendwann in das Sektenlager gelockt wurde.
